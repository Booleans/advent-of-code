...
# Part 1 solution.
print(
    f"The intersection closest to the central port is {closest_intersection} with Manhattan distance {min_distance}."
)
...
# Part 2 solution.
print(
    f"The coordinate with the lowest combined signal delay is {best_coordinate} with combined steps of {min_steps}."
)
